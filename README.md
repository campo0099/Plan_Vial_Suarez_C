...
<head>
  ...
  <style>
    ...
    *,*::before,*::after { box-sizing: inherit; }
    ...
    .logo{width:70px;height:70px;border-radius:10px;object-fit:cover;border:3px solid #edf2f7}
    .title{flex:1}
    .title h1{margin:0;font-family:Montserrat,Arial;font-size:17px;color:var(--accent);letter-spacing:0.6px}
